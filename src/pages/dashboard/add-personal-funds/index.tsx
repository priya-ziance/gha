...
// import { Col, FileDropzone, FileInput, FormGroup, FormItemSelect, ImageDropzone, PageHeading, Row, Switch } from "../../../components";
...
//       pick(props.addPersonalFunds.personalFunds, Object.keys(helpers.initialValues))
//     );
...
//     console.log("doccccccc on change",documentFile);
    
//   }

//   const getDocumentText = () => {
//     if (documentFile) {
//       console.log("dockkkkk",documentFile);
...
//     //   let file: any = await uploadFile(Document);
//     //   console.log("upload Document : ", JSON.stringify(file));
//     //   values.image = file?.id;
//     // }

//     const { resetForm, setSubmitting } = options;
//     setSubmitting(true);
//     const personalFundsId: any = get(props, "personalFunds.id", "");
...
//         console.log("vaalues ,.document",values);
...
//                           setFieldValue("community_activity_save", personalFunds.community_activity_save);
//                           setFieldValue("document", personalFunds.document);
//                           setFieldValue("expense", personalFunds.expense);
//                           setFieldValue("expense_date", personalFunds.expense_date);
//                           setFieldValue("expense_description", personalFunds.expense_description);
//                           // setFieldValue("expense_type", personalFunds.expense_type);
//                           setFieldValue("inventory_save", personalFunds.inventory_save);
...
//                           onChange={e => {
//                             setFieldValue('community_activity_save', get(e, 'target.checked'))
//                           }}
//                         />
//                         <Switch
...
//                           onChange={e => {
//                             setFieldValue('inventory_save', get(e, 'target.checked'))
//                           }}
//                         />
