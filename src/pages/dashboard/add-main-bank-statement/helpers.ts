...
import { MAIN_ACCOUNT_FIELDS_TYPE} from '../../../types';

const formFields: any = Object.keys(FIELDS);

export const initialValues = Object.assign({}, ...formFields.map((formField: MAIN_ACCOUNT_FIELDS_TYPE) => {
  return {
...
export const validationSchema = yup.object().shape(
  Object.assign({}, ...formFields.map((formField: MAIN_ACCOUNT_FIELDS_TYPE) => {
    return {
