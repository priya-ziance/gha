...
import { RECURRING_EXPENSES_FIELDS_TYPE } from '../../../types';
...
export const initialValues = Object.assign({}, ...formFields.map((formField: RECURRING_EXPENSES_FIELDS_TYPE) => {
  return {
...
export const validationSchema = yup.object().shape(
  Object.assign({}, ...formFields.map((formField: RECURRING_EXPENSES_FIELDS_TYPE) => {
    return {
