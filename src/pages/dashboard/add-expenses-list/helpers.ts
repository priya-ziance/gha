...
import { EXPENSES_LIST_FIELDS_TYPE } from '../../../types';
...
export const initialValues = Object.assign({}, ...formFields.map((formField: EXPENSES_LIST_FIELDS_TYPE) => {
  return {
...
export const validationSchema = yup.object().shape(
  Object.assign({}, ...formFields.map((formField: EXPENSES_LIST_FIELDS_TYPE) => {
    return {
